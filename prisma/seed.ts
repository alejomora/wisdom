...
async function main() {
  ...
  const rewards = [
    // ── AVATARS (Common) ──
    { slug: 'avatar-fox', name: 'Fox Avatar', nameEs: 'Avatar Zorro', description: 'A clever fox avatar', descriptionEs: 'Un avatar de zorro astuto', type: 'avatar', icon: '🦊', cost: 1250, rarity: 'common' },
    { slug: 'avatar-cat', name: 'Cat Avatar', nameEs: 'Avatar Gato', description: 'A cute cat avatar', descriptionEs: 'Un avatar de gato adorable', type: 'avatar', icon: '🐱', cost: 1250, rarity: 'common' },
    { slug: 'avatar-dog', name: 'Dog Avatar', nameEs: 'Avatar Perro', description: 'A loyal dog avatar', descriptionEs: 'Un avatar de perro leal', type: 'avatar', icon: '🐶', cost: 1300, rarity: 'common' },
    { slug: 'avatar-bear', name: 'Bear Avatar', nameEs: 'Avatar Oso', description: 'A strong bear avatar', descriptionEs: 'Un avatar de oso fuerte', type: 'avatar', icon: '🐻', cost: 1350, rarity: 'common' },
    { slug: 'avatar-rabbit', name: 'Rabbit Avatar', nameEs: 'Avatar Conejo', description: 'A quick rabbit avatar', descriptionEs: 'Un avatar de conejo veloz', type: 'avatar', icon: '🐰', cost: 1350, rarity: 'common' },
    { slug: 'avatar-panda', name: 'Panda Avatar', nameEs: 'Avatar Panda', description: 'A chill panda avatar', descriptionEs: 'Un avatar de panda relajado', type: 'avatar', icon: '🐼', cost: 1450, rarity: 'common' },
    { slug: 'avatar-penguin', name: 'Penguin Avatar', nameEs: 'Avatar Pingüino', description: 'A dapper penguin avatar', descriptionEs: 'Un avatar de pingüino elegante', type: 'avatar', icon: '🐧', cost: 1450, rarity: 'common' },
    { slug: 'avatar-owl', name: 'Owl Avatar', nameEs: 'Avatar Búho', description: 'A wise owl avatar', descriptionEs: 'Un avatar de búho sabio', type: 'avatar', icon: '🦉', cost: 1550, rarity: 'common' },
    { slug: 'avatar-frog', name: 'Frog Avatar', nameEs: 'Avatar Rana', description: 'A funny frog avatar', descriptionEs: 'Un avatar de rana divertido', type: 'avatar', icon: '🐸', cost: 1550, rarity: 'common' },
    { slug: 'avatar-monkey', name: 'Monkey Avatar', nameEs: 'Avatar Mono', description: 'A playful monkey avatar', descriptionEs: 'Un avatar de mono juguetón', type: 'avatar', icon: '🐒', cost: 1600, rarity: 'common' },
    // ── AVATARS (Rare) ──
    { slug: 'avatar-tiger', name: 'Tiger Avatar', nameEs: 'Avatar Tigre', description: 'A fierce tiger avatar', descriptionEs: 'Un avatar de tigre feroz', type: 'avatar', icon: '🐯', cost: 1900, rarity: 'rare' },
    { slug: 'avatar-lion', name: 'Lion Avatar', nameEs: 'Avatar León', description: 'The king of the jungle', descriptionEs: 'El rey de la selva', type: 'avatar', icon: '🦁', cost: 2000, rarity: 'rare' },
    { slug: 'avatar-wolf', name: 'Wolf Avatar', nameEs: 'Avatar Lobo', description: 'A fierce wolf avatar', descriptionEs: 'Un avatar de lobo feroz', type: 'avatar', icon: '🐺', cost: 1900, rarity: 'rare' },
    { slug: 'avatar-eagle', name: 'Eagle Avatar', nameEs: 'Avatar Águila', description: 'Soar above the rest', descriptionEs: 'Vuela por encima del resto', type: 'avatar', icon: '🦅', cost: 1950, rarity: 'rare' },
    { slug: 'avatar-dolphin', name: 'Dolphin Avatar', nameEs: 'Avatar Delfín', description: 'A smart dolphin avatar', descriptionEs: 'Un avatar de delfín inteligente', type: 'avatar', icon: '🐬', cost: 1950, rarity: 'rare' },
    { slug: 'avatar-horse', name: 'Horse Avatar', nameEs: 'Avatar Caballo', description: 'A majestic horse avatar', descriptionEs: 'Un avatar de caballo majestuoso', type: 'avatar', icon: '🐴', cost: 2000, rarity: 'rare' },
    { slug: 'avatar-gorilla', name: 'Gorilla Avatar', nameEs: 'Avatar Gorila', description: 'A powerful gorilla avatar', descriptionEs: 'Un avatar de gorila poderoso', type: 'avatar', icon: '🦍', cost: 2100, rarity: 'rare' },
    { slug: 'avatar-shark', name: 'Shark Avatar', nameEs: 'Avatar Tiburón', description: 'Rule the ocean', descriptionEs: 'Domina el océano', type: 'avatar', icon: '🦈', cost: 2100, rarity: 'rare' },
    { slug: 'avatar-octopus', name: 'Octopus Avatar', nameEs: 'Avatar Pulpo', description: 'Multitask like a pro', descriptionEs: 'Multitarea como un profesional', type: 'avatar', icon: '🐙', cost: 2200, rarity: 'rare' },
    { slug: 'avatar-parrot', name: 'Parrot Avatar', nameEs: 'Avatar Loro', description: 'Speak many languages', descriptionEs: 'Habla muchos idiomas', type: 'avatar', icon: '🦜', cost: 2200, rarity: 'rare' },
    // ── AVATARS (Epic) ──
    { slug: 'avatar-dragon', name: 'Dragon Avatar', nameEs: 'Avatar Dragón', description: 'A legendary dragon avatar', descriptionEs: 'Un avatar de dragón legendario', type: 'avatar', icon: '🐉', cost: 2800, rarity: 'epic' },
    { slug: 'avatar-phoenix', name: 'Phoenix Avatar', nameEs: 'Avatar Fénix', description: 'Rise from the ashes', descriptionEs: 'Renace de las cenizas', type: 'avatar', icon: '🔥', cost: 3000, rarity: 'epic' },
    { slug: 'avatar-robot', name: 'Robot Avatar', nameEs: 'Avatar Robot', description: 'Future is now', descriptionEs: 'El futuro es ahora', type: 'avatar', icon: '🤖', cost: 2800, rarity: 'epic' },
    { slug: 'avatar-alien', name: 'Alien Avatar', nameEs: 'Avatar Alienígena', description: 'Out of this world', descriptionEs: 'Fuera de este mundo', type: 'avatar', icon: '👽', cost: 2900, rarity: 'epic' },
    { slug: 'avatar-ninja', name: 'Ninja Avatar', nameEs: 'Avatar Ninja', description: 'Silent and deadly', descriptionEs: 'Silencioso y letal', type: 'avatar', icon: '🥷', cost: 3000, rarity: 'epic' },
    { slug: 'avatar-wizard', name: 'Wizard Avatar', nameEs: 'Avatar Mago', description: 'Master of spells', descriptionEs: 'Maestro de hechizos', type: 'avatar', icon: '🧙', cost: 3100, rarity: 'epic' },
    { slug: 'avatar-astronaut', name: 'Astronaut Avatar', nameEs: 'Avatar Astronauta', description: 'To infinity and beyond', descriptionEs: 'Hasta el infinito y más allá', type: 'avatar', icon: '👨‍🚀', cost: 3200, rarity: 'epic' },
    { slug: 'avatar-superhero', name: 'Superhero Avatar', nameEs: 'Avatar Superhéroe', description: 'Save the day', descriptionEs: 'Salva el día', type: 'avatar', icon: '🦸', cost: 3400, rarity: 'epic' },
    // ── AVATARS (Legendary) ──
    { slug: 'avatar-unicorn', name: 'Unicorn Avatar', nameEs: 'Avatar Unicornio', description: 'A magical unicorn avatar', descriptionEs: 'Un avatar de unicornio mágico', type: 'avatar', icon: '🦄', cost: 5000, rarity: 'legendary' },
    { slug: 'avatar-crown', name: 'Crown Avatar', nameEs: 'Avatar Corona', description: 'Royal and majestic', descriptionEs: 'Real y majestuoso', type: 'avatar', icon: '👑', cost: 6000, rarity: 'legendary' },
    { slug: 'avatar-diamond', name: 'Diamond Avatar', nameEs: 'Avatar Diamante', description: 'Unbreakable brilliance', descriptionEs: 'Brillantez irrompible', type: 'avatar', icon: '💎', cost: 7000, rarity: 'legendary' },
    { slug: 'avatar-sun', name: 'Sun Avatar', nameEs: 'Avatar Sol', description: 'Shine like the sun', descriptionEs: 'Brilla como el sol', type: 'avatar', icon: '☀️', cost: 8000, rarity: 'legendary' },
    { slug: 'avatar-galaxy', name: 'Galaxy Avatar', nameEs: 'Avatar Galaxia', description: 'The universe within you', descriptionEs: 'El universo dentro de ti', type: 'avatar', icon: '🌌', cost: 11000, rarity: 'legendary' },
